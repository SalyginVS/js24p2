...
function t09() {
    const dateInput = document.querySelector('.i-9').value;
...
function t10(time) {
    ...
    document.querySelector('.i-10').value = `${year}-${month}-${day}`;
}
...
function t12() {
    const year = 2024;
    const month = document.querySelector('.s-121').value;
